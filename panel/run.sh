    ...
    while true; do
        ...
        case $p in
            1) 
                ...
                pause ;;
            2) 
                bash <(curl -fsSL https://raw.githubusercontent.com/DreamHost2ws/ExtremLightingCode/main/panel/pterodactyl/run.sh)
                pause ;;
            3) 
                bash <(curl -fsSL https://raw.githubusercontent.com/DreamHost2ws/ExtremLightingCode/main/panel/Jexactyl/run.sh)
                pause ;;
            4) 
                bash <(curl -fsSL https://raw.githubusercontent.com/DreamHost2ws/ExtremLightingCode/main/panel/unJexactyl.sh)
                pause ;;
            5) 
                bash <(curl -fsSL https://raw.githubusercontent.com/DreamHost2ws/ExtremLightingCode/main/panel/undash-3.sh)
                pause ;;
            6) 
